...
class ChiffreEnLettreService 
{
  ...
  private $units =
      array(
        "Francs CFA" => array(
          100,
          "fr-FR" => array('Francs CFA', 'Francs CFA', 'centime', 'centimes', '', ''),
          "pt-PT" => array('Francs CFA', 'Francs CFA', 'cêntimo', 'cêntimos', 'm', 'm'),
          "en-EN" => array('Francs CFA', 'Francs CFA', 'cent', 'cents', '')
        ),
        "USD" => array(
          100,
   ...
   * @example
   * $obj = new ChiffreEnLettre("12345.67", "EUR");
  ...
  function __construct($nb, $unit){
    ...
    if (ChiffreEnLettreService::DEBUG) echo "construct : [" . $this->nb . "]";
  }
  ...
  private function getThree($group, $unit, $language, $gender){
    ...
    if (ChiffreEnLettreService::DEBUG) echo "<br>local a [" . $return . "] ";
    // Exceptions.
    ...
    if (ChiffreEnLettreService::DEBUG) echo "<br>local b $unit [" . $return . "] ";
    // Exceptions de genre.
    ...
    if (ChiffreEnLettreService::DEBUG) echo "<br>local c [" . $return . "] ";
    return $return;
  }
  ...
  private function part($nb, $language, $gender){
    ...
    if (ChiffreEnLettreService::DEBUG) echo "<br>part a : [" . $return . "]";
    // Exceptions.
    ...
    if (ChiffreEnLettreService::DEBUG) echo "<br>part b : [" . $return . "]";
    return $return;
  }
  ...
  function convert($language){
    ...
    if (ChiffreEnLettreService::DEBUG) echo "<br>";
    return $return;
  }
}
?>